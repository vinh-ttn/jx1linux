...
function helpgoldquest()
    ...
    if lvl >= 20 and lvl < 30 then

    	tinsert(tb, "Phô tuyÕn ChÝnh ph¸i/#gquest_step2(2,1,1)")
		tinsert(tb, "Phô tuyÕn Trung lËp/#gquest_step2(2,1,2)")
		tinsert(tb, "Phô tuyÕn Tµ ph¸i/#gquest_step2(2,1,3)")

		tinsert(tb, "ChÝnh tuyÕn ChÝnh ph¸i/#gquest_step2(1,1,1)")
		tinsert(tb, "ChÝnh tuyÕn Trung lËp/#gquest_step2(1,1,2)")
		tinsert(tb, "ChÝnh tuyÕn Tµ ph¸i/#gquest_step2(1,1,3)")


    
	end

	if lvl >= 30 and lvl < 40 then
    	tinsert(tb, "Phô tuyÕn ChÝnh ph¸i/#gquest_step2(2,2,1)")
		tinsert(tb, "Phô tuyÕn Trung lËp/#gquest_step2(2,2,2)")
		tinsert(tb, "Phô tuyÕn Tµ ph¸i/#gquest_step2(2,2,3)")	
		

		tinsert(tb, "ChÝnh tuyÕn ChÝnh ph¸i/#gquest_step2(1,2,1)")
		tinsert(tb, "ChÝnh tuyÕn Trung lËp/#gquest_step2(1,2,2)")
		tinsert(tb, "ChÝnh tuyÕn Tµ ph¸i/#gquest_step2(1,2,3)")
    
	end

	if lvl >= 40 and lvl < 50 then
    	tinsert(tb, "Phô tuyÕn ChÝnh ph¸i/#gquest_step2(2,3,1)")
		tinsert(tb, "Phô tuyÕn Trung lËp/#gquest_step2(2,3,2)")
		tinsert(tb, "Phô tuyÕn Tµ ph¸i/#gquest_step2(2,3,3)")	


		tinsert(tb, "ChÝnh tuyÕn ChÝnh ph¸i/#gquest_step2(1,3,1)")
		tinsert(tb, "ChÝnh tuyÕn Trung lËp/#gquest_step2(1,3,2)")
		tinsert(tb, "ChÝnh tuyÕn Tµ ph¸i/#gquest_step2(1,3,3)")
    	
	end

	if lvl >= 50 and lvl < 60 then
    	tinsert(tb, "Phô tuyÕn ChÝnh ph¸i/#gquest_step2(2,4,1)")
		tinsert(tb, "Phô tuyÕn Trung lËp/#gquest_step2(2,4,2)")
		tinsert(tb, "Phô tuyÕn Tµ ph¸i/#gquest_step2(2,4,3)")	


		tinsert(tb, "ChÝnh tuyÕn ChÝnh ph¸i/#gquest_step2(1,4,1)")
		tinsert(tb, "ChÝnh tuyÕn Trung lËp/#gquest_step2(1,4,2)")
		tinsert(tb, "ChÝnh tuyÕn Tµ ph¸i/#gquest_step2(1,4,3)")
	...
	if lvl >= 60 then	
		...
		tinsert(tb, "ChÝnh tuyÕn ChÝnh ph¸i/#gquest_step2(1,5,1)")
		tinsert(tb, "ChÝnh tuyÕn Trung lËp/#gquest_step2(1,5,2)")
		tinsert(tb, "ChÝnh tuyÕn Tµ ph¸i/#gquest_step2(1,5,3)")
	end
